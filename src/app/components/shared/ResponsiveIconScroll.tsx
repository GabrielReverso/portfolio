...
export default function ResponsiveIconScroll() {
    return (
        <>
            <div className={`${isMobile ? "flex" : "hidden"} justify-center relative h-8 aspect-[2/3] rounded-md border-2 border-gray-300`}>
            ...
            <div className={`${isMobile ? "hidden" : "flex"} flex justify-center relative h-8 aspect-[2/3] rounded-3xl border-2 border-gray-300`}>
