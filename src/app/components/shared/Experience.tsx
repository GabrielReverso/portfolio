    ...
    return (
        <div className="flex flex-col my-10 w-full md:w-auto">
            <div className="flex flex-col md:flex-row md:h-16">
                <div className="aspect-square mb-4 md:mb-0 ml-4 md:ml-0 w-10 md:w-auto md:h-full rounded-full bg-blue-500 flex justify-center items-center">
                ...
                <div className="h-full flex flex-col justify-between ml-4 md:ml-5">
