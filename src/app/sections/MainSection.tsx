			...
			<div className="flex flex-row wrapper">
				<aside id="main-section" className="pt-10 md:pt-40">
					...
					<div className="flex flex-row gap-3 mt-6 items-center font-[family-name:var(--font-geist-mono)]">
						<p className="text-[1.7rem] md:text-5xl">
							Desenvolvedor
						</p>
						<Typewriter
							options={{ loop: true }}
							onInit={(typewriter) => {
								typewriter
									.typeString(
										'<span class="Typewriter__mobile">Mobile</span>'
									)
									.pauseFor(2500)
									.deleteAll()
									.typeString(
										'<span class="Typewriter__desktop">Desktop</span>'
									)
									.pauseFor(2500)
									.deleteAll()
									.typeString(
										'<span class="Typewriter__web">Web</span>'
									)
									.pauseFor(2500)
									.deleteAll()
									.start();
