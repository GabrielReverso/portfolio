...
export default function Header() {
	...
	useEffect(() => {
		setHeaderTitle(
			isMobile ? "Gabriel Reverso" : "Gabriel Reverso Pereira"
		);
	}, [isMobile]);
	...
	return (
		<>
			<header className="select-none fixed h-20 w-screen top-0 bg-[#0f0c29] shadow-lg shadow-[#0003] z-30">
				<div className="flex flex-row items-center justify-between wrapper">
					...
					<div
						...
						className="flex-col justify-center items-center aspect-square h-[60%] rounded-lg bg-[#251f57] shadow-sm shadow-black hover:bg-[#191442] transition-all"
					>
			...
			>
				...
				<nav
					id="nav-side"
					className={`flex flex-col bg-[#251f57] w-[500px] h-full`}
				>
					<div
